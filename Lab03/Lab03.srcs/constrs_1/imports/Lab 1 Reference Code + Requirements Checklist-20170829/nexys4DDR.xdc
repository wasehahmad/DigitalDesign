...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { SW[8] }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { send_ext }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
